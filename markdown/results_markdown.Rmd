...
gg_wrc_release =
  ...
  geom_point()+
  labs(x = "pore size (um)",
       y = expression("volume of pores (cm"^3*")"))+
...
```{r appendix1_wrc, fig.height=4, fig.width=10}
library(patchwork)
...
# combined biplots ----
library(patchwork)
gg_pca = ggbiplot_scl+ggbiplot_sl +
...
```{r nmr_pca_combined, fig.height=6.5, fig.width=6.5}
